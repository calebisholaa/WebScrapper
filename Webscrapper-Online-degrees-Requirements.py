...
with open('Programs_Requirements_Online Degrees.csv', mode='w') as csv_file:
...
with open('All_Programs_Requirement.csv', mode='a') as csv_file:
        ...
        for study in graduateProgramList:
	        writer.writerow(["Online Degree" ,study.programName,study.transcript,study.recommendation, study.gpa, study.testScores, study.personalState, study.additionalReq])