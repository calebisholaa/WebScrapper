...
with open('Programs_Requirements_Masters.csv', mode='w') as csv_file:
...
with open('All_Programs_Requirement.csv', mode='a') as csv_file:
        ...
        for study in graduateProgramList:
	        writer.writerow(["Masters" ,study.programName,study.transcript,study.recommendation, study.gpa, study.testScores, study.personalState, study.additionalReq])